...
if (empty($termo)):
	...
	$sql = 'SELECT distinct b.id, b.foto, b.carteirinha, b.pl_saude, b.nome, b.sexo, b.dt_nascimento, b.email, b.tp_sanguineo, b.ft_rh, b.peso, b.altura, b.pai, b.mae, b.telefone, b.celular, b.endereco, b.alergia, b.coracao, b.respiracao, b.especial, b.outros, b.observacao, b.proximo, b.tel_proximo, b.cel_proximo, b.adesao, a.status, a.id_bravo, a.cod_matricula, a.id_matricula, a.turma   FROM tab_bravos as b INNER JOIN tb_matricula as a on b.id = a.id_bravo';
...
// Executa uma consulta baseada no termo de pesquisa passado como parâmetro
	$conexao = conexao::getInstance();
	$sql = 'SELECT distinct b.id, b.foto, b.carteirinha, b.pl_saude, b.nome, b.sexo, b.dt_nascimento, b.email, b.tp_sanguineo, b.ft_rh, b.peso, b.altura, b.pai, b.mae, b.telefone, b.celular, b.endereco, b.alergia, b.coracao, b.respiracao, b.especial, b.outros, b.observacao, b.proximo, b.tel_proximo, b.cel_proximo, b.adesao, a.status, a.id_bravo, a.cod_matricula, a.id_matricula, a.turma  FROM tab_bravos as b INNER JOIN tb_matricula as a on b.id = a.id_bravo WHERE nome LIKE :nome OR email LIKE :email OR endereco LIKE :endereco OR status LIKE :status';
	$stm = $conexao->prepare($sql);
									...
									<div class="table "  >
										<table class="table">
											<thead>
													...
													<tbody>
													<tr>
														<td class="col-lg-1"><?=$cliente->id_bravo?></td>	
