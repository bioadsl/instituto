...
if (!empty($id_cliente) && is_numeric($id_cliente)) :
    ...
    $conexao = conexao::getInstance();
    $sql = 'SELECT * FROM tb_matricula WHERE id_bravo = :id_cliente';
    $stm = $conexao->prepare($sql);
	...
	$stm = $conexao->prepare($sql);
	$stm->execute();
	$registros1 = $stm->fetch(PDO::FETCH_OBJ);
	...
	$stm = $conexao->prepare($sql);
	$stm->execute();
	$registros2 = $stm->fetch(PDO::FETCH_OBJ);
...
<div class='container'>
                        ...
                        <div class="row" style="padding-top: 10%; text-align: center;">
                            <a href='avaliacao_pais1.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-success btn-lg">1º Bimestre</a>
                            <a href='avaliacao_pais2.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-success btn-lg">2º Bimestre</a>
                        </div>
