...
<head>
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="margin-top: 30px;">
            <h1>Avaliação de disciplinas pelos Guardiões 3º Bimestre</h1>
        </div>
    </div>
    <hr>
    <div class='container'>
...
<legend>Avaliem das disciplinas segundo os critérios abaixo</legend>              
            ...
            <fieldset>
                    ...
                    <div class="col-lg-2">          
                        <label for="ordem_unida">Ordem Unida 2</label>
                    ...
                    <div class="col-lg-2">          
                        <label for="habilidades">Habilidades Manuais 2</label>
                    ...
                    <div class="col-lg-2">          
                        <label for="prim_socorros">Primeiros Socorros 2</label>
                    ...
                    <div class="col-lg-3">          
                        <label for="prev_acidentes">Prevenção de Acidentes 2</label>
                ...
                <div class="row" style="padding-top: 10%;">
                    <div class="col-lg-4">
                        <input type="hidden" name="acao" value="avaliacao_bimestre_3">
