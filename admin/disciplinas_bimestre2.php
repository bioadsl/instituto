...
<head>
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="margin-top: 30px;">
            <h1>Avaliação de disciplinas pelos Guardiões 2º Bimestre</h1>
        </div>
    </div>
    <hr>
    <div class='container'>
...
<div class='container'>
        ...
        <legend>Avaliem das disciplinas segundo os critérios abaixo</legend>              
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-2">          
                            <label for="nos_amarras">Nós e Amarras 1</label>
                        ...
                        <div class="col-lg-2">          
                            <label for="xadrez">Xadrez 1</label>
                        ...
                        <div class="col-lg-2">          
                            <label for="sobrevivencia">Sobrevivência 1</label>
                        ...
                        <div class="col-lg-3">          
                            <label for="orientacao">Orientação 1</label>
                ...
                <div class="row" style="padding-top: 10%;">
                    <div class="col-lg-4">
                        <input type="hidden" name="acao" value="avaliacao_bimestre_2">
