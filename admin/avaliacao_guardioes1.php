...
<head>
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="margin-top: 30px;">
            <h1>Avaliação pelos Guardiões 1º Semestre</h1>
        </div>
    </div>
    <hr>
    <div class='container'>
        ...
        <legend>Avaliem segundo os critérios abaixo</legend>              
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-2">          
                            ...
                            <select class="form-control" name="lideranca" id="lideranca">
                            ...
                            <span class='msg-erro msg-lideranca'></span>
                        </div>
                        ...
                        <div class="col-lg-2">          
                            ...
                            <span class='msg-erro msg-disciplina'></span>
                        </div>
                        
                        <div class="col-lg-2">          
                            <label for="camaradagem">Camaradagem</label>
                            <select class="form-control" name="camaradagem" id="camaradagem">
                                <option value="">Selecione a nota</option>
                                <option value="1">1-Insuficiente</option>
                                <option value="2">2-Regular</option>
                                <option value="3">3-Bom </option>
                            ...
                            <span class='msg-erro msg-camaradagem'></span>
                        </div>      
                        ...
                        <div class="col-lg-2">          
                            ...
                            <span class='msg-erro msg-iniciativa'></span>
                        </div> 

                        <div class="col-lg-3">          
                            <label for="assiduidade">Assiduidade</label>
