...
if ($acao == 'incluir_avaliacao_pais_semestre_2'):
		...
		$sql = 'UPDATE tb_avaliacao2 SET  matricula=:matricula, turma=:turma, data=:data, nome=:nome, obediencia2=:obediencia2,  respeito2=:respeito2, organizacao2=:organizacao2, servico2=:servico2, ds_escolar2=:ds_escolar2  where id_inscrito = :id_inscrito';
		...
		if ($acao == 'incluir_avaliacao_guardioes_semestre_2'):
			...
			$sql = 'UPDATE tb_avaliacao2 SET disciplina2=:disciplina2, camaradagem2=:camaradagem2, iniciativa2=:iniciativa2, assiduidade2=:assiduidade2, lideranca2=:lideranca2 where id_inscrito = :id_inscrito';
