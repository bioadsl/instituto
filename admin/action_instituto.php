...
<body>
	<div class='container box-mensagem-crud'>
		...
		if ($acao == 'incluir') :
			...
			$sql = 'INSERT INTO tab_instituto (foto, carteirinha, pl_saude, nome, sexo, dt_nascimento, email, tp_sanguineo, ft_rh, peso, altura, pai, mae, telefone, celular, endereco, alergia, coracao, respiracao, especial, outros, observacao, proximo, tel_proximo, cel_proximo, adesao, senha, rg, cpf, id_atendimento, escolaridade, escola) VALUES (:foto, :carteirinha, :pl_saude, :nome, :sexo, :dt_nascimento, :email, :tp_sanguineo, :ft_rh, :peso, :altura, :pai, :mae, :telefone, :celular, :endereco, :alergia, :coracao, :respiracao, :especial, :outros, :observacao, :proximo, :tel_proximo, :cel_proximo, :adesao, :senha, :rg, :cpf, :id_atendimento, :escolaridade, :escola)';
		...
		if ($acao == 'incluir_publico') :
			...
			$sql = 'INSERT INTO tab_instituto (foto, carteirinha, pl_saude, nome, sexo, dt_nascimento, email, tp_sanguineo, ft_rh, peso, altura, pai, mae, telefone, celular, endereco, alergia, coracao, respiracao, especial, outros, observacao, proximo, tel_proximo, cel_proximo, adesao, senha, rg, cpf, id_atendimento, status, escolaridade, escola)
		...
		if ($acao == 'excluir') :
			...
			$sql = "SELECT foto FROM tab_instituto WHERE id = :id AND foto <> 'padrao.jpg'";
			$stm = $conexao->prepare($sql);
			$stm->bindValue(':id', $id);
			$stm->execute();
			...
			$sql = 'DELETE FROM tab_instituto WHERE id = :id';
			$stm = $conexao->prepare($sql);
			$stm->bindValue(':id', $id);
			$retorno = $stm->execute();
