...
if (!empty($id_cliente) && is_numeric($id_cliente) && !empty($id_matricula) && is_numeric($id_matricula)) :
        ...
        <div class='container'>
            ...
            <div class="row">
                    <div class="col-4" style="padding-top: 5%;">
                        <input type="hidden" name="acao" value="editar_matricula">
                        <input type="hidden" name="id_bravo" value="<?=$cliente->id?>">
                        <input type="hidden" name="cod_matricula"  value="<?=$registro->cod_matricula?>">
                        <input type="hidden" name="nome" value="<?=$cliente->nome?>">
                        <input type="hidden" name="data" value="<?=date('d/m/y');?>">
                        <input type="hidden" name="turma" value="<?=$registro->turma?>">
                        <input type="hidden" name="id_matricula" value="<?=$registro->id_matricula?>">
                    <div>
                    ...
                    <div class="col-4">
                        ...
                        <a href='consulta_turma.php' class="btn btn-danger">voltar</a>
                    </div>
