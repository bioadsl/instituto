...
*/
	...
	$sql = "SELECT id, nome, email, data_nascimento FROM tab_clientes WHERE data_nascimento like'%{$hoje}' or '%{$hoje2}'order by 2";
...
$msg = "Parabéns {$nome},<br>Feliz Aniversário!<br> São os votos dos seus irmãos da CAP!";
