...
if (empty($termo)) :
	...
	$sql = 'SELECT distinct b.foto, m.id_matricula, m.cod_matricula, m.turma, m.data, m.id_inscrito, m.nome, m.status FROM tb_matricula as m  inner join tab_instituto b on m.id_inscrito=b.id order by 7';
	...
	$conexao = conexao::getInstance();
	$sql = 'SELECT id, foto, nome FROM tab_instituto';
	$stm = $conexao->prepare($sql);
	$stm->execute();
								...
								<tr>
									...
									<td class="col-1 col-lg-2">
										...
										<div class="form-check">
											<input type="radio" id="<?= $bravo->id_inscrito ?>" name="presenca[<?= $bravo->id_inscrito ?>]" value="P">
									...
									<td class="col-1 col-lg-2">
										...
										<div class="form-check">
											<input type="radio" id="<?= $bravo->id_inscrito ?>" name="presenca[<?= $bravo->id_inscrito ?>]" value="F">
