...
if (!empty($id_cliente) && is_numeric($id_cliente)) :
    ...
    $sql = 'SELECT *  FROM tab_instituto WHERE id = :id';
...
<head>
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="margin-top: 30px;">
            <h1>Avaliação de disciplinas pelos Guardiões 4º Bimestre</h1>
        </div>
    </div>
    <hr>
    <div class='container'>
        ...
        <form action="action_grade2.php" method="post" id='form-contato' enctype='multipart/form-data'>
...
<div class='container'>
        ...
        <legend>Avaliem das disciplinas segundo os critérios abaixo</legend>              
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-2">          
                            <label for="civismo">Civismo 2</label>
                        ...
                        <div class="col-lg-2">          
                            <label for="nos_amarras">Nó e Amarras 2</label>
                            <select class="form-control" name="nos_amarras" id="nos_amarras">
                                <option value="">Selecione a nota</option>
                                <option value="1">1-Insuficiente</option>
                                <option value="2">2-Regular</option>
                                <option value="3">3-Bom </option>
                            ...
                            <span class='msg-erro msg-nos_amarras'></span>
                        </div>
                        
                        <div class="col-lg-2">          
                            <label for="xadrez">Xadrez 2</label>
                            <select class="form-control" name="xadrez" id="xadrez">
                                <option value="">Selecione a nota</option>
                                <option value="1">1-Insuficiente</option>
                                <option value="2">2-Regular</option>
                                <option value="3">3-Bom </option>
                            ...
                            <span class='msg-erro msg-xadrez'></span>
                        </div>      
                        
                        <div class="col-lg-2">          
                            <label for="sobrevivencia">Sobrevivência 2</label>
                            <select class="form-control" name="sobrevivencia" id="sobrevivencia">
                                <option value="">Selecione a nota</option>
                                <option value="1">1-Insuficiente</option>
                                <option value="2">2-Regular</option>
                                <option value="3">3-Bom </option>
                            ...
                            <span class='msg-erro msg-sobrevivencia'></span>
                        </div> 

                        <div class="col-lg-3">          
                            <label for="orientacao">Orientação 2</label>
                            <select class="form-control" name="orientacao" id="orientacao">
                                <option value="">Selecione a nota</option>
                                <option value="1">1-Insuficiente</option>
                                <option value="2">2-Regular</option>
                                <option value="3">3-Bom </option>
                            ...
                            <span class='msg-erro msg-orientacao'></span>
                        </div> 
                ...
                <div class="row" style="padding-top: 10%;">
                    <div class="col-lg-4">
                        <input type="hidden" name="acao" value="avaliacao_bimestre_4">
