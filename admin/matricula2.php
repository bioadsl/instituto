        ...
        <div class='container'>
            ...
            <div class="row">
                    <div class="col-4" style="padding-top: 5%;">
                        <input type="hidden" name="acao" value="efetuar_matricula_semestre_2">
                        <input type="hidden" name="status" value="Matriculado">
                        <input type="hidden" name="id_inscrito" value="<?=$cliente->id?>">
                        ...
                        <input type="hidden" name="turma" value="<?php echo '2-'.date('Y');?>">
                    <div>
