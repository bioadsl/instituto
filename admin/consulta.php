					...
					<tbody>
						<tr>
							...
							<td class="col-1 col-lg-2">
								...
								<a href='carteira.php?id=<?= $cliente->id ?>'> <i class="bi bi-person-vcard" style="font-size: 30px"></i> </a>
								<a href='matricula1.php?id=<?= $cliente->id ?>'> <i class="bi bi-mortarboard" style="font-size: 30px"></i> </a>
								<a href='editar.php?id=<?= $cliente->id ?>'> <i class="bi bi-pencil-square" style="font-size: 30px"></i> </a>
								<a href='atendimento.php?id=<?= $cliente->id ?>'> <i class="bi bi-folder-plus" style="font-size: 30px"></i> </a>
