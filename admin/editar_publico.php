...
if (!empty($id_cliente) && is_numeric($id_cliente)):
	...
	$sql = 'SELECT id, foto, carteirinha, pl_saude, nome, sexo, dt_nascimento, email, tp_sanguineo, ft_rh, peso, altura, pai, mae, telefone, celular, endereco, alergia, coracao, respiracao, especial, outros, observacao, proximo, tel_proximo, cel_proximo, adesao, senha  FROM tab_instituto WHERE id = :id';
        ...
        <fieldset>
         ...
         <?php if(empty($cliente)):?>
            ...
            <form action="action_bravos.php" method="post" id='form-contato' enctype='multipart/form-data'>
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="rg" name="rg" value="<?=$cliente->rg?>"
                            placeholder="Informe o Nº do rg">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            value="<?=date('d/m/Y', strtotime($cliente->dt_nascimento));?>" name="data_nascimento" >
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">teste@teste.com
                            <label for="proximo">Nome de um parente ou pessoa próxima</labelteste@teste.com>
                            <input type="text" class="form-control" id="proximo" name="proxiteste@teste.commo"
                ...
                <hr>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            placeholder="<?=$cliente->senha?>" placeholder="Informe uma senha">
                        ...
                        <div class="col-lg-3">
                            ...
                            placeholder="<?=$cliente->senha?>"  name="confirmacao" placeholder="Confirme sua senha" onfocusout="validatePassword()">
