            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control nome" id="escolaridade" name="escolaridade"  placeholder="Infome a escolaridade">
                        <span class='msg-erro msg-pai'></span>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control nome" id="escola" name="escola"  placeholder="Infome o nome da sua escola">
