...
if (!empty($id_cliente) && is_numeric($id_cliente)) :
    ...
    $sql1 = 'SELECT * FROM tb_matricula WHERE id_instituto = :id_cliente';
...
<head>
    ...
    <div class='container'>
        ...
        <form action="action_avaliacao1.php" method="post" id='form-contato' enctype='multipart/form-data'>
...
<div class='container'>
                        ...
                        <div class="row" style="padding-top: 1%; text-align: center;">
                            <a href='avaliacao_guardioes1.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-success btn-lg"> Avaliação comportamental 1º Semestre</a>
                            <a href='avaliacao_guardioes2.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-success btn-lg"> Avaliação comportamental 2º Semestre</a>
                        </div>

                        <legend style="padding-top: 1%;">Avaliação das disciplinas</legend>   
           
                        <div class="row" style="padding-top: 1%; text-align: center;">
                            <a href='disciplinas_bimestre1.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-info btn-lg">1º Bimestre</a>
                            <a href='disciplinas_bimestre2.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-info btn-lg">2º Bimestre</a>
                            <a href='disciplinas_bimestre3.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-info btn-lg">3º Bimestre</a>
                            <a href='disciplinas_bimestre4.php?id=<?=$cliente->id?>&id_matricula=<?=$regs->id_matricula?>' class="btn btn-info btn-lg">4º Bimestre</a>
                        </div>
       
            <div class="row" style="padding-top: 1%;">
                <div class="col-lg-6">
                    <input type="hidden" name="acao" value="incluir_avaliacao_guardioes_semestre_1">
