...
<html>
  <head>
    <meta charset="UTF-8">
        <title>Administrativo - Cadastro de Usuário ADM</title>
  ...
  <div align="center">
        ...
        <?php else: ?>
            <form class="pure-form pure-form-aligned" method="post">
                <fieldset>
                    <legend style="margin-left: 0%;"> <h2>Administrativo - Cadastro de Usuário ADM</h2> </legend>
                    ...
                    <div class="pure-controls">
                        ...
                        <a href='?pagina=consulta_adm' class="btn btn-danger">Voltar</a>
                    </div>
                </fieldset>
            </form>
        <?php endif; ?>
