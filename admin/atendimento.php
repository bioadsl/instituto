...
if (!empty($id_cliente) && is_numeric($id_cliente)) :
    ...
    $cliente = $stm->fetch(PDO::FETCH_OBJ);
            ...
            $sql1 = 'SELECT  id_atendimento, atendido, conselheiro, convenio, tipo, descricao, agendamento, data, exame, status FROM atendimento ';
                ...
                <div class="row">
                                <div class="col-lg-4">
                                            ...
                                            <select class="form-control" id="convenio" name="convenio">
                                                ...
                                                <option value="CAP-PIUMA">CAP-PIUMA</option>   
                                                <option value="CAP-PB">CAP-PB</option>       
                                            </select>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="agendamento" maxlength="10" value="" name="agendamento">
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control" id="conselheiro" name="conselheiro">
                                                ...
                                                <option value="Pr Washington">Pr Washington</option>
                                                <option value="Pra Elilian">Pra Elilian</option>
                                                <option value="Pr Cristiano">Pr Cristiano</option>
                                                <option value="Roberto">Roberto</option>
                                                <option value="Prs Washington e Elilian">Prs Washington e Elilian</option>                                                                                    
                                            </select>
                                            <span class='msg-erro msg-conselheiro'></span>
                                        </div>
...
<!-- 
                            ...
                            <div class="row">
                                        ...
                                        <label for="descricao">Descrição</label>
                                         <textarea class="form-control" id="descricao" name="descricao" rows="5" placeholder=""></textarea>
        ...
        <div class="row">
            <div class="col-4">
                <input type="hidden" name="acao" value="incluir_atendimento">
                <input type="hidden" name="id" value="<?=$cliente->id?>">
                <input type="hidden" name="id_atendido" value="<?=$cliente->id?>">
                <input type="hidden" name="atendido" value="<?=$cliente->nome?>">
                <input type="hidden" name="id_atendimento" formaction="action_instituto.php" value="<?=$atendimento->id_atendimento?>">
                ...
                <div class="col-4">
                    ...
                    <a href='consulta_atendimento.php' class="btn btn-danger">voltar</a>
                </div>
