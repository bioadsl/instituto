...
if (empty($termo)):
	...
	$sql = 'SELECT distinct b.id, b.foto, b.carteirinha, b.pl_saude, b.nome, b.sexo, b.dt_nascimento, b.email, b.tp_sanguineo, b.ft_rh, b.peso, b.altura, b.pai, b.mae, b.telefone, b.celular, b.endereco, b.alergia, b.coracao, b.respiracao, b.especial, b.outros, b.observacao, b.proximo, b.tel_proximo, b.cel_proximo, b.adesao, a.conselheiro, a.status, a.id_atendimento  FROM tab_instituto as b INNER JOIN atendimento as a on b.id = a.id_atendido order by a.id_atendimento desc';
...
<div class='container'>
						<fieldset>
										...
										<form action="consulta_atendimento.php" method="post" id='form-contato' class="form-horizontal col-md-10">
											<div class="row">
												<div class="col-lg-6">
