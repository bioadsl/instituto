...
if ($acao == 'avaliacao_bimestre_3'):
		...
		$sql = 'UPDATE tb_grade2 SET ordem_unida2=:ordem_unida2, taf2=:taf2, prim_socorros2=:prim_socorros2, prev_acidentes2=:prev_acidentes2, habilidades2=:habilidades2 where id_bravo = :id_bravo';
		...
		if ($acao == 'avaliacao_bimestre_4'):	
			...
			$sql = 'UPDATE tb_grade2 SET civismo2=:civismo2, nos_amarras2=:nos_amarras2, xadrez2=:xadrez2, sobrevivencia2=:sobrevivencia2, orientacao2=:orientacao2  where id_bravo = :id_bravo';
