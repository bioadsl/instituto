...
if ($acao == 'incluir_avaliacao_pais_semestre_1'):
		...
		$sql = 'UPDATE tb_avaliacao1 SET  matricula=:matricula, turma=:turma, data=:data, nome=:nome, obediencia1=:obediencia1,  respeito1=:respeito1, organizacao1=:organizacao1, servico1=:servico1, ds_escolar1=:ds_escolar1  where id_bravo = :id_bravo';
		...
		if ($acao == 'incluir_avaliacao_guardioes_semestre_1'):
			...
			$sql = 'UPDATE tb_avaliacao1 SET disciplina1=:disciplina1, camaradagem1=:camaradagem1, iniciativa1=:iniciativa1, assiduidade1=:assiduidade1, lideranca1=:lideranca1 where id_bravo = :id_bravo';
