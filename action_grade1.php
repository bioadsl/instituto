...
if ($acao == 'avaliacao_bimestre_1'):
		...
		$sql = 'UPDATE tb_grade1 SET ordem_unida1=:ordem_unida1, taf1=:taf1, prim_socorros1=:prim_socorros1, prev_acidentes1=:prev_acidentes1, habilidades1=:habilidades1 where id_bravo = :id_bravo';
		...
		if ($acao == 'avaliacao_bimestre_2'):	
			...
			$sql = 'UPDATE tb_grade1 SET civismo1=:civismo1, nos_amarras1=:nos_amarras1, xadrez1=:xadrez1, sobrevivencia1=:sobrevivencia1, orientacao1=:orientacao1  where id_bravo = :id_bravo';
