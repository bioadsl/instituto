...
echo '<img src="'.$src.'">';*/	
		...
		$sql = 'INSERT INTO tb_estoque (id_produto, nome_produto, tamanho_produto, quantidade, data, foto_produto) VALUES (:id_produto, :nome_produto, :tamanho_produto, :quantidade, :data, :foto_produto)';
 ...
 $sql = 'UPDATE tb_estoque SET nome_produto=:nome_produto, tamanho_produto=:tamanho_produto, quantidade=:quantidade, id_produto=:id_produto,  data=:data, foto_produto=:foto_produto   WHERE id_registro=:id_registro';
