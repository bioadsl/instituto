...
$sql = 'SELECT `id_matricula`, `cod_matricula`, `turma`, `data`, `id_bravo`, `nome`, `status` FROM `tb_matricula` WHERE id_bravo = :id';
...
// Captura os dados do atendimento solicitado
$conexao = conexao::getInstance();
$sql = 'SELECT `id_grade1`, `id_bravo`, `matricula`, `turma`, `data`, `nome`, `civismo1`, `nos_amarras1`, `xadrez1`, `sobrevivencia1`, `orientacao1`, `ordem_unida1`, `habilidades1`, `taf1`, `prim_socorros1`, `prev_acidentes1` FROM `tb_grade1` WHERE id_bravo = :id';
$stm = $conexao->prepare($sql);
$stm->bindValue(':id', $id_cliente);
$stm->execute();
...
// Captura os dados do atendimento solicitado
$conexao = conexao::getInstance();
$sql = 'SELECT `id_grade2`, `id_bravo`, `matricula`, `turma`, `data`, `nome`, `civismo2`, `nos_amarras2`, `xadrez2`, `sobrevivencia2`, `orientacao2`, `ordem_unida2`, `habilidades2`, `taf2`, `prim_socorros2`, `prev_acidentes2` FROM `tb_grade2` WHERE id_bravo = :id';
$stm = $conexao->prepare($sql);
$stm->bindValue(':id', $id_cliente);
$stm->execute();
